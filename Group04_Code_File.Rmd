...
#Firstly, We will do our correlation matrix to detirmine the correlation between the independent variables and our respons variable, but since our data contain numirc and nonnumirc variable, we will do the correlation matrix manually.
...
# After computing the correlation matrix, we will try to run models for each variable to detirmine which variable has the highest impact.
...
# After computing the models, we will create a new dataset to impelement our First model based on the variables that we saw a high impact on them.
