...
#Now, we will view the results of Backward elimination regression
anova(BackwardModel2)
#Finally, we will view our model of backward elimination method.
...
*Stipwisedata2* represent the data that we are going to use to impalement our model using Forward stepwise method.

To implement our forward stepwise method we should foمlow the folمowing steps:
